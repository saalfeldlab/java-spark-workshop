	...
	public static void main(String[] args) throws IOException {
		...
		if ( o.isParsedSuccessfully() ) {
	        ...
	        for ( int i = 0;  i < size; ++i )
				for ( int k = i + 1; k < size && k - i <= range; ++i )
...
//	        	System.out.println( fnwi );
			...
			JavaPairRDD<Tuple2<Integer, Integer>, Tuple2<FloatProcessorInfo, FloatProcessorInfo>> filePairs = sc
					...
					.mapToPair(new PairFunction<Tuple2<Tuple2<Integer, Integer>, Tuple2<String, String>>, Tuple2<Integer, Integer>, Tuple2<FloatProcessorInfo, FloatProcessorInfo>>() {
					...
					.mapToPair(new PairFunction<Tuple2<Tuple2<Integer, Integer>, Tuple2<FloatProcessorInfo, FloatProcessorInfo>>, Tuple2<Integer, Integer>, Tuple2<FloatProcessorInfo, FloatProcessorInfo>>() {
						public Tuple2<Tuple2<Integer, Integer>, Tuple2<FloatProcessorInfo, FloatProcessorInfo>> call(
			...
			JavaPairRDD<Tuple2<Integer, Integer>, Double> similarities = filePairs.mapToPair(new PairFunction<Tuple2<Tuple2<Integer, Integer>, Tuple2<FloatProcessorInfo, FloatProcessorInfo>>, Tuple2<Integer, Integer>, Double>() {
